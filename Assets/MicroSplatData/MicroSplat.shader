...
Shader "Terrain"
{
   ...
   SubShader
   {
            Tags {"RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "24"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_Base-314895738"
   Fallback "Hidden/Terrain_Base-314895738"
